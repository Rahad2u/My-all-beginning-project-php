...
<html lang="en">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="./V_ALL_Function.php">
    ...
    <div class="collapse navbar-collapse" id="navbarNav"  style="display: flex; justify-content: center;">
      <ul class="navbar-nav" style="font-size: 19px; font-weight: 500;">
        <li class="nav-item">
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="./V_ALL_Function.php">Home</a>
        </li>
        <li class="nav-item" >
  ...
  <form action="./V_ALL_Function.php?logout=true" method="POST">
        ...
        <div class="text-f bg-primary p-3" style="display: flex; justify-content: center; color: #fff; margin-bottom: 15px;">
              ...
              <div class="student-table">
                ...
                <tbody>
                  ...
                  <a href='./V_ALL_Function.php?del_id=$id' class='btn btn-danger'>Delete</a>
                  </td>
                </tbody>
                ";
                }
