               ...
               <div class="col-lg-10">
                 ...
                 <h2>User List</h2>
                   ...
                   echo "<table class='table table-success'>
                    <thead>
                     <th style='width: 310px;'>First Name</th>
                     <th style='width: 353px;'>Last Name</th>
                     <th style='width: 353px;'>Email</th>
                     <th>Action</th>
                     </thead>
                     <tbody>
                  ";
                   while($sql_array       = mysqli_fetch_assoc($sql_q)){
                      $user_id1           = $sql_array['user_id1'];
                      $user_first_name    = $sql_array['user_first_name'];
                      $user_last_name     = $sql_array['user_last_name'];
                      $user_email         = $sql_array['user_email'];
                      echo "<tr>
                      <td>$user_first_name</td>
                      <td>$user_last_name</td>
                      <td>$user_email</td>
                      <td style='width: 130px;'>
                      <a href='edit_user_document.php?id=$user_id1' class='btn btn-primary'>Edit</a>
                      </td>
                      </tr>";
                   }
                  echo "
