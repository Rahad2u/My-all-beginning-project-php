               ...
               <div class="col-lg-8">
                   ...
                   if(isset($_GET[$product_name])){
                    ...
                    if($product_n!='' && $product_c!='' && $product_code!='' && $product_e_date!=''){
                     $sql = "INSERT INTO product_table(product_name, product_categori, product_code, product_entry_date	)
                     VALUE ('$product_n', '$product_c', '$product_code', '$product_e_date')";
                   ...
                   <form action="<?php $_SERVER['PHP_SELF']; ?>" method="GET" class="shadow-lg p-3" style="color: #fff; background-color: #273c75; border-radius: 5px;">
                     ...
                     <div class="mb-3">
                       <label for="product_name" class="form-label">Select product categori</label>
                       <select name="product_cetagori" id="product_name" class="form-select mb-3">
