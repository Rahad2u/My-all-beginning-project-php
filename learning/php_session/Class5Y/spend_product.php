           ...
           <div class="row">
               ...
               <?php 
                   if(isset($_GET[$spend_product_name])){
                     ...
                     $sp_product_n       = $_GET[$spend_product_name];
                     $spend_P_quen       = $_GET[$spend_p_quentity];
                     $spend_pro_date     = $_GET[$spend_p_date];

                    if($spend_product_name!='' && $spend_p_quentity!='' && $spend_p_date!=''){
                     $sql = "INSERT INTO spend_product_table(spend_product_name, spend_product_quentity, spend_product_date)
                     VALUE ('$sp_product_n', '$spend_P_quen', '$spend_pro_date')";
                  ...
                  ?>
                   <form action="<?php $_SERVER['PHP_SELF']; ?>" method="GET" class="shadow-lg p-3" style="color: #fff; background-color: #273c75; border-radius: 5px;">
                     ...
                     <div class="mb-3">
                       <label for="store_product_name" class="form-label">Spend produt name</label>
                     ...
                     <div class="mb-3">
                       <label for="product_code" class="form-label">Spend product quentity</label>
                       <input type="text" class="form-control" id="product_code" name="spend_p_quentity" value="<?php  ?>">
                     </div>
                     <div class="mb-3">
                       <label for="date" class="form-label">Spend product date</label>
                       <input type="date" class="form-control" id="date" name="spend_p_date" value="<?php   ?>">
