...
<html lang="en">
  <head>
    ...
    />
    <title>Spand Product Table</title>
  ...
  <div class="container-fluid">
    ...
    <div class="col-lg-8">
    <section class="category_list" style="margin-top: 40px;">
       <div class="container">
           <div class="row">
             <div class="col-lg-1"></div>
               <div class="col-lg-10">
                 <div class="text-categori mb-4" style="text-align: center; color: #000;">
                 <h2>Spaned product list</h2>
                 </div>
                   <?php 
                   $sql = "SELECT * FROM spend_product_table";
                   ...
                   echo "<table class='table table-success'>
                    <thead>
                     ...
                     <th>Spend entry Date</th>
                     <th>Action</th>
                     </thead>
                     <tbody>
                  ";
                   while($sql_array       = mysqli_fetch_assoc($sql_q)){
                      $s_product_id         = $sql_array['spend_product_id'];
                      $s_product_name       = $sql_array['spend_product_name'];
                      $s_product_Quentity   = $sql_array['spend_product_quentity'];
                      $s_product_date       = $sql_array['spend_product_date'];
                      echo "<tr>
                      <td>$s_product_name </td>
                      <td>$s_product_Quentity</td>
                      <td>$s_product_date</td>
                      <td style='width: 130px;'>
                      <a href='edit_spend_product.php?id=$s_product_id' class='btn btn-primary'>Edit</a>
                      </td>
                      </tr>";
