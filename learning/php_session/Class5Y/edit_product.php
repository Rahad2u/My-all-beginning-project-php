                 ...
                 <h2>Product category list</h2>
                  ...
                  ";
                   while($sql_array       = mysqli_fetch_assoc($sql_q)){
                      $product_id         = $sql_array['product_id'];
                      $product_name       = $sql_array['product_name'];
                      $product_categori   = $sql_array['product_categori'];
                      $product_code       = $sql_array['product_code'];
                      $entry_date         = $sql_array['product_entry_date'];
                      echo "<tr>
                      <td>$product_name</td>
                      ...
                      <a href='edit_p_name.php?id=$product_id' class='btn btn-primary'>Edit</a>
                      </td>
                      </tr>";
