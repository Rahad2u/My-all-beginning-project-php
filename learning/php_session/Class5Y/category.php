...
$category_date = htmlspecialchars('category_e_d');
?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<div class="col-lg-8">
<section class="category_Add" style="margin-top: 100px;">
       <div class="container">
           <div class="row">
               ...
               <div class="col-lg-8">
                   ...
                   if(isset($_GET['category_n'])){
                     ...
                     $category_date = $_GET['category_e_d'];

                    if($category_name!='' && $category_date!=''){
                     $sql = "INSERT INTO product_store(category_name, category_entry_date)
                     VALUE ('$category_n', '$category_date')";
                     $sql_q = mysqli_query($connect, $sql);
                   }
                  }
                   ?>
                   <form action="category.php" method="GET" class="shadow-lg p-3" style="color: #fff; background-color: #273c75; border-radius: 5px;">
                     ...
                     <div class="mb-3">
                       ...
                       <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="category_n">
                     </div>
                     <div class="mb-3">
                       <label for="date" class="form-label">Categori entry date</label>
                       <input type="date" class="form-control" id="date" name="category_e_d">
                     </div>
