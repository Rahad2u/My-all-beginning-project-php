...
<html lang="en">
  <head>
    ...
    />
    <title>List of Product name</title>
...
<div class="container-fluid">
  ...
  <div class="col-lg-3 p-3 shadow-sm" style="border: 1px solid #c56cf0; background: #c56cf0; height: 100%; margin-top: 3px; margin-left: 3px;"><!-- categori left !-->
    ...
    <div class="col-lg-8">
    <section class="category_list" style="margin-top: 30px;">
       <div class="container">
           <div class="row">
                 ...
                 <h2>Product list</h2>
                  ...
                  ";
                   while($sql_array = mysqli_fetch_assoc($sql_q)){
                      ...
                      $s_product_Quentity   = $sql_array['store_product_quantity'];
                      $s_product_date       = $sql_array['store_product_entry_date'];
                      ...
                      <a href='edit_store_p_name.php?id=$s_product_id' class='btn btn-primary'>Edit</a>
                      </td>
                      </tr>";
