...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <div class="col-lg-8">
    <section class="category_Add" style="margin-top: 70px;">
       <div class="container">
           <div class="row">
               ...
               <?php 
                   if(isset($_POST[$user_firstname])){
                     ...
                     $u_f_name       = $_POST[$user_firstname];
                     $u_l_name       = $_POST[$user_lastname];
                    ...
                    if($user_firstname!='' && $user_lastname!='' && $user_email!='' && $user_password!=''){
                     ...
                     VALUE ('$u_f_name', '$u_l_name', '$u_email', '$user_password')";
                  ...
                  ?>
                   <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" class="shadow-lg p-3" style="background: #2c214d; color: #fff;">
                     <div class="text-form mb-5" style="text-align: center; color: #fff;">
                      ...
                      <div class="col-lg-6">
                       <div class="mb-3">
                         ...
                         <input type="text" placeholder="First name" class="form-control" id="firstname" name="user_firstname">
                       </div>
                       </div>
                       <div class="col-lg-6">
                       <label for="lastname" class="mb-1">Last name*</label>
                         <input type="text" placeholder="Last name" class="form-control" id="lastname" name="user_lastname">
                       </div>
                       <div class="col-lg-6">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                     ...
                     <button type="submit" class="btn btn-primary" style="background: #5d701d; border: 1px #5d701d;">Submit</button>
                   </form>
               </div>
               <div class="col-lg-1"></div>
           </div>
